...
{
    public partial class Suppliers_AddEditForm : Form
    {
        ...
        public Suppliers_AddEditForm()
        {
            InitializeComponent();
            Init();
        }
        public Suppliers_AddEditForm(DBT_Suppliers obj)
        {
            InitializeComponent();
            Object = obj;
            Init();
        ...
        private void Init()
        {
            ...
            textBox_CompanyName.MaxLength = 254;
