...
{
    public partial class Stock_ViewForm : Form
    {
        ...
        public Stock_ViewForm()
        {
            InitializeComponent();

            this.Load += Stock_ViewForm_Load;
        ...
        private void Stock_ViewForm_Disposed(object? sender, EventArgs e)
        {
            this.Load -= Stock_ViewForm_Load;
            this.Disposed -= Stock_ViewForm_Disposed;
            button_update.Click -= Button_update_Click;
        ...
        {
            new Stock_AddEditForm(DBT_Stock.GetById((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value)).ShowDialog();
            UpdateTable();
        }

        private void Button_create_Click(object? sender, EventArgs e)
        {
            new Stock_AddEditForm().ShowDialog();
            UpdateTable();
        }
        ...
        private void Button_remove_Click(object? sender, EventArgs e)
        {
            ...
            int res = DBT_Stock.Remove((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value);
        ...
        private void Stock_ViewForm_Load(object sender, EventArgs e) => UpdateTable();
