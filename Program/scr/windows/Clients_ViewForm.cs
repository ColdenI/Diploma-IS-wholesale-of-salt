...
{
    public partial class Clients_ViewForm : Form
    {
        ...
        {
            new Clients_AddEditForm(DBT_Clients.GetById((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value)).ShowDialog();
            UpdateTable();
        }

        private void Button_create_Click(object? sender, EventArgs e)
        {
            new Clients_AddEditForm().ShowDialog();
            UpdateTable();
        }
