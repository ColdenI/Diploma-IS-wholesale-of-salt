...
{
    public partial class Services_ViewForm : Form
    {
        ...
        public Services_ViewForm()
        {
            InitializeComponent();

            this.Load += Services_ViewForm_Load;
            this.Disposed += Services_ViewForm_Disposed;
        ...
        private void Services_ViewForm_Disposed(object? sender, EventArgs e)
        {
            this.Load -= Services_ViewForm_Load;
            this.Disposed -= Services_ViewForm_Disposed;
            button_update.Click -= Button_update_Click;
        ...
        {
            new Services_AddEditForm(DBT_Services.GetById((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value)).ShowDialog();
            UpdateTable();
        }

        private void Button_create_Click(object? sender, EventArgs e)
        {
            new Services_AddEditForm().ShowDialog();
            UpdateTable();
        }
        ...
        private void Button_remove_Click(object? sender, EventArgs e)
        {
            ...
            int res = DBT_Services.Remove((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value);
        ...
        private void Services_ViewForm_Load(object sender, EventArgs e) => UpdateTable();
